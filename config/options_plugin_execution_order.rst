...
.. caution::
   ...
   When you save your changes, they will be applied immediately and do not depend on clicking the :guilabel:`Make It So!` button. Similarly, clicking the :guilabel:`Cancel`, :guilabel:`Restore Defaults` or :guilabel:`Restore all Defaults` buttons on the main Plugins option page will not change the plugin execution order saved perviously.
